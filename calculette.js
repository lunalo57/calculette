...
const calculerTotal = () => {
    ...
    if (nombre1 == null || nombre2 == null || operation == null) {
        return;
    }
...
document
    .getElementById("plus")
    .addEventListener("click", () => saisirOperation("+"));
document
    .getElementById("moins")
    .addEventListener("click", () => saisirOperation("-"));
document
    .getElementById("fois")
    .addEventListener("click", () => saisirOperation("x"));
document
    .getElementById("divise")
    .addEventListener("click", () => saisirOperation("/"));
document
    .getElementById("zero")
    .addEventListener("click", () => saisirNombre(0));
document.getElementById("un").addEventListener("click", () => saisirNombre(1));
document
    .getElementById("deux")
    .addEventListener("click", () => saisirNombre(2));
document
    .getElementById("trois")
    .addEventListener("click", () => saisirNombre(3));
document
    .getElementById("quatre")
    .addEventListener("click", () => saisirNombre(4));
document
    .getElementById("cinq")
    .addEventListener("click", () => saisirNombre(5));
document.getElementById("six").addEventListener("click", () => saisirNombre(6));
document
    .getElementById("sept")
    .addEventListener("click", () => saisirNombre(7));
document
    .getElementById("huit")
    .addEventListener("click", () => saisirNombre(8));
document
    .getElementById("neuf")
    .addEventListener("click", () => saisirNombre(9));
document
    .getElementById("virgule")
    .addEventListener("click", () => saisirDecimale());
document
    .getElementById("egal")
    .addEventListener("click", () => calculerTotal());